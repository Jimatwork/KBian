...
public class AudioConvert {
	...
	public static void main(String[] args) {
		// pcm参数转换
		// convert("东部信息.wav", "eguid.wav", avcodec.AV_CODEC_ID_PCM_S16LE, 8000,
		// 16000,1);
		// pcm转mp3编码示例
		convert("https://app.kuedit.com/KuBianImg/img/1527565113801/yueduaiqing.m4a",
				"C:\\Users\\Administrator\\Desktop\\mu/yueduaiqing.mp3", avcodec.AV_CODEC_ID_MP3, 8000, 16, 1);
	}
}